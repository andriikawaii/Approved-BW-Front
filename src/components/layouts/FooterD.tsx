...
export default function FooterD({
  ...
  const newHavenPhone = formatPhone(phones.find((item) => item.label.toLowerCase().includes('new haven'))?.number || NEW_HAVEN_FALLBACK);
            ...
            <div className="footer-a-brand-details">
              <div className="footer-a-row">
                ...
                <div className="footer-a-row-text">
                  <a href={toTelHref(newHavenPhone)} className="footer-a-primary-phone">{newHavenPhone}</a>
              ...
              <div className="footer-a-row">
                ...
                <div className="footer-a-row-text">
                  <a href={`mailto:${SUPPORT_EMAIL}`} className="footer-a-email footer-a-email-d">{SUPPORT_EMAIL}</a>
                  <a
                    href="https://www.google.com/maps/search/?api=1&query=206A+Boston+Post+Road,+Orange,+CT+06477"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="footer-a-address footer-a-address-d"
                  >
