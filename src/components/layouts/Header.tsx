        ...
        <div className="relative mx-auto flex h-16 max-w-[1240px] items-center justify-between px-8">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="hidden whitespace-nowrap rounded-[6px] bg-[#9a7340] px-[22px] py-[10px] text-[12px] font-semibold uppercase tracking-[0.5px] text-white transition-all duration-200 hover:-translate-y-px hover:bg-[#a57d48] lg:inline-flex"
            >
        ...
        <div className="fixed inset-0 z-[1050] lg:hidden">
          ...
          <div className="relative flex h-full flex-col items-center justify-center gap-7 px-6 text-center">
            ...
            <button
              ...
              className="mt-4 inline-flex items-center gap-2 rounded-[4px] bg-[#9a7340] px-8 py-4 text-[15px] font-semibold text-white transition-all duration-200 hover:-translate-y-px hover:bg-[#a57d48]"
            >
              Get Your Free Estimate
            </button>
          </div>
