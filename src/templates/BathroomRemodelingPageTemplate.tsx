...
import { ArrowRight, CalendarDays, Check, ChevronDown, Droplets, FileText, Grid2x2, Hammer, House, RectangleHorizontal, Shield, ShieldCheck, Star, Upload, Wrench, Zap } from "lucide-react";
...
export function BathroomRemodelingPageTemplate({ page }: { page: CMSPage }) {
  ...
  const overview = sections<RichTextData>(page, "rich_text").find((item) => item.title?.includes("Full-Service Bathroom Remodeling"));
  ...
  const introParts = parts(intro?.title, "Bathroom Remodel");
  ...
  return (
    <div className="bg-[#f5f1e9] text-[#1e2b43]">
      <section className="relative isolate min-h-[560px] overflow-hidden bg-[#151e30] px-5 pb-16 pt-[82px] text-white md:px-10">
        <div className="absolute inset-0 bg-cover bg-center opacity-75" style={{ backgroundImage: `url(${media(hero?.background_image, "/images/headers/bathroom-remodeling-header.jpg")})` }} />
        ...
        <div className="relative z-10 mx-auto flex min-h-[440px] max-w-[1240px] flex-col items-center justify-center text-center">
          <ol className="mb-6 flex list-none items-center justify-center text-[12px] font-semibold text-white/90">
            ...
            <li className="before:px-2.5 before:text-[#bc9155] before:content-['›']"><span className="text-white">Bathroom Remodeling</span></li>
          </ol>
      ...
      <section className="bg-[#f5f1e9] px-5 py-20 md:px-10">
        <div className="mx-auto max-w-[1240px]">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.02fr_1fr] lg:items-start">
            <div className="grid gap-4">
              <div className="overflow-hidden rounded-[16px] bg-white shadow-[0_20px_50px_rgba(30,43,67,0.12)]">
                <img src={media(intro?.image_main, "/images/services/bathroom-remodel-new.jpg")} alt="Bathroom remodel" className="h-[250px] w-full object-cover md:h-[286px]" />
              </div>
              <div className="overflow-hidden rounded-[16px] bg-white shadow-[0_20px_50px_rgba(30,43,67,0.12)]">
                <img src={media(intro?.image_secondary, "/portfolio/builtwell-contractor-sign-consultation-ct-01.jpg")} alt="Bathroom consultation" className="h-[250px] w-full object-cover md:h-[286px]" />
              </div>
            </div>
            <div className="rounded-[16px] border border-[#e5dccd] bg-white px-8 py-8 shadow-[0_18px_42px_rgba(30,43,67,0.08)] md:px-10">
              <div className="space-y-6 text-[14px] leading-[1.95] text-[#5c677d] md:text-[15px]">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {(intro?.bullet_points || []).map((item: any, index: number) => (
              <article key={`${item.text}-${index}`} className="flex min-h-[266px] flex-col items-center rounded-[16px] border border-[#e6ddcf] bg-white px-7 py-8 text-center shadow-[0_12px_30px_rgba(30,43,67,0.06)]">
                ...
                <p className="mt-4 max-w-[250px] text-[14px] leading-[1.75] text-[#5c677d]">
                  {INTRO_CARD_COPY[item.text] || "Included as part of a full-scope bathroom remodeling project."}
                </p>
              </article>
            ))}
          </div>
      ...
      <section className="bg-white px-5 py-20 md:px-10">
        <div className="mx-auto max-w-[1240px]">
          <div className="mb-12 text-center">
            {label("Recent Work")}
            <h2 className="text-[clamp(34px,3.8vw,48px)] font-bold tracking-[-0.02em]">Recent Bathroom <span className="text-[#bc9155]">Remodeling Projects</span></h2>
            ...
            {(caseStudies?.projects || []).map((project: any, index: number) => (
              <article key={`${project.location}-${index}`} className="overflow-hidden rounded-[12px] border border-[#e6dece] bg-[#fdfcfa] shadow-[0_14px_32px_rgba(30,43,67,0.08)]">
                <div className="relative grid h-[240px] grid-cols-2 overflow-hidden">
                  <img src={media(project.before_image, "/images/services/bathroom-remodel-new.jpg")} alt={`${project.location} before`} className="h-full w-full object-cover" />
      ...
      <section className="relative overflow-hidden bg-[#142033] px-5 py-20 text-white md:px-10">
        ...
        <div className="relative z-10 mx-auto max-w-[1240px]">
          <div className="mb-10 text-center">
            ...
            <h2 className="text-[clamp(34px,3.8vw,48px)] font-bold tracking-[-0.02em]">Our Bathroom <span className="text-[#bc9155]">Remodeling Process</span></h2>
      ...
      <section className="bg-[#f5f1e9] px-5 py-20 md:px-10">
        <div className="mx-auto max-w-[980px]">
          <div className="mb-10 text-center">
            {label("FAQ")}
            <h2 className="text-[clamp(34px,3.8vw,48px)] font-bold tracking-[-0.02em]">Bathroom Remodeling <span className="text-[#bc9155]">Questions</span></h2>
          </div>
      ...
      <section className="bg-[#f5f1e9] px-5 py-20 md:px-10">
        <div className="mx-auto max-w-[1240px]">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-3 max-w-[640px] text-[15px] leading-[1.8] text-[#5c677d]">Many bathroom remodeling projects include or lead to these related services.</p>
          </div>
          <div className="grid gap-7 lg:grid-cols-3">
            {(related?.items || []).map((item: any, index: number) => (
              <article key={`${item.title}-${index}`} className="overflow-hidden rounded-[12px] border border-[#e5dac8] bg-white shadow-[0_14px_32px_rgba(30,43,67,0.06)]">
                <div className="h-[220px] overflow-hidden"><img src={media(item.image, "/images/services/bathroom-remodel-new.jpg")} alt={item.title} className="h-full w-full object-cover transition-transform duration-500 hover:scale-105" /></div>
                <div className="p-6">
